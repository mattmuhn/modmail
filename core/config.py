...
class ConfigManager:
    ...
    public_keys = {
        ...
        "thread_creation_response": "El Staff se pondrá en contacto contigo lo antes posible.",
        ...
        "thread_close_footer": "Responder creará un nuevo hilo",
        "thread_close_title": "Hilo Cerrado",
        "thread_close_response": "{closer.mention} ha cerrado este hilo de Reporte.",
        "thread_self_close_response": "Has cerrado este hilo de Soporte.",
        "thread_move_notify": False,
        "thread_move_response": "Este hilo ha sido movido.",
        "disabled_new_thread_title": "No entregado",
        "disabled_new_thread_response": "No aceptamos nuevos hilos.",
        "disabled_new_thread_footer": "Intenta mas tarde...",
        "disabled_current_thread_title": "No entregado",
        "disabled_current_thread_response": "No aceptamos nuevos mensajes.",
        "disabled_current_thread_footer": "Intenta mas tarde...",
        # moderation
